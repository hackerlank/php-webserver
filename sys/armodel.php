 ...
 *
 */
class sys_armodel extends sys_model
{
    /**
     *
     * @var type 
    ...
    private function run($sql=NULL)
    {
        ...
        {
            case 'find':
                    $res = $this->_db->find($_DT_,$this->_where,$aOption);
                    break;
            case 'findall':
                    $res = $this->_db->findAll($_DT_,$this->_where,$aOption);
                    break;
            case 'insert':
                    $res = $this->_db->insert($_DT_,$this->_data);
                    break;
            case 'delete':
                    $res = $this->_db->delete($_DT_,$this->_where,$aOption);
                    break;
            case 'update':
                    $res = $this->_db->update($_DT_,$this->_data,$this->_where,$aOption);
                    break;
            case 'execute':
            ...
            case 'query':
                    ...
                    break;
            case 'count':
                    $res = $this->_db->count($_DT_,$this->_where,$aOption);
                    break;
            case 'mapping':
                    $res = $this->_db->find($_DT_,$this->_where,$aOption);
                    break;
