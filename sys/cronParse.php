...
class sys_cronParse{
	public static function next($cronStr, $start=null){
		if (empty($start)){
			$start = time();
		}
	 ...
	 */
	protected static function _next_crontab_day(array $from, &$range)
	{
	 ...
	 */
	protected static function _next_crontab_hour(array $from,  &$range)
	{
	 ...
	 */
	protected static function _next_crontab_minute(array $from,  &$range)
	{
	 ...
	 */
	protected static function _next_crontab_month(array $from,  &$range)
	{
	 ...
	 */
	protected static function _next_crontab_monthday(array $from,  &$range)
	{
		if ($from['mday'] >= end($range['monthdays']))
		{
			// No next Day of Month, use next Month
	 ...
	 */
	protected static function _next_crontab_weekday(array $from,  &$range)
	{
		// Calculate effective Day of Month for next Day of Week
